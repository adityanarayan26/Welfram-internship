...
const Carousel2 = () => {
    ...
    const Table = [
        {
            id: 1,
            img: "https://s3-alpha-sig.figma.com/img/544e/3029/c4c7cd0100e27f205801be034a1511b4?Expires=1734912000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=UObQ1jdNLafDs35tHDWdbnI2uzfOLubZe~VeQQgEzp-RQ9Sqoq-abOSfTxoGqZ3ilk1R8wmsBLVSD5XErWDgw7ydHqMRBfQjRaaVylP68~6VToFE8bTWnA1~rKuus~oKIvAKV4rfOE8C2VgPnbVGIs4~HEywB-OVRuMP1xKQM84QmxP71f49-CxMzchX8m4xhIugKSLQIajXCgCTH1Gn3fvzzdMqzlExIVky0Z4cHz5qfzEZN5pbt2KWVNeW7c3NDPNh0J92t9KRIk1ZSdLduweifPASbqnUSW~vdt-HmnjDmiuVg75wtE5T9VSWJc0H82waaMtDwq1EOkHWoFyn~g__"
    ...
    return (
        <div className="w-full px-4 py-8 bg-[#FDFBFB]">
            <div className="flex justify-between px-10 pb-5">
                ...
                <h1 className='font-medium text-4xl '>Ces produits pourraient vous intéresser</h1>
                <h1 className="text-lg font-medium uppercase underline">Voir toute la collection</h1>
            </div>
                        ...
                        {Table.map((_, index) => (
                            ...
                            >
                                <div className=" w-full  flex flex-col gap-y-2 justify-center items-center rounded-lg  overflow-hidden h-full cursor-pointer  font-sans  py-3">
                                    <div className="bg-[#F9F7F5] w-full flex flex-col items-center justify-center  shadow-sm rounded-md" >
